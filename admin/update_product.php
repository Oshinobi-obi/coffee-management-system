...
if(isset($_POST['update'])){
   ...
   $update_product = $conn->prepare("UPDATE `products` SET name = ?, details = ?, category = ?, price = ?, availability = ? WHERE id = ?");
   $update_product->execute([$name, $details, $category, $price, $availability, $pid]);
...
<head>
   ...
   <title>Loris | Update Product</title>
...
<section class="update-product">
   ...
   <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
      ...
      <textarea name="dtls" class="box" required placeholder="Enter Product Details" maxlength="500" cols="10" rows="5"><?= $fetch_products['details']; ?></textarea>
      <span>Update Price</span>
      <input type="number" required placeholder="Enter Product Price" name="price" class="box" value="<?= $fetch_products['price']; ?>">
